...
MUST_KNOW = [
    ...
    "Between logins or follow-ups, run `{cli} ui situation` then `{cli} ui state` / `{cli} ui click N` — same CDP session, browser stays open.",
    "When the task is fully done: `{cli} ui close` (or `{cli} browser-use disconnect --account <name>`).",
